...
@dataclass
class SVDDora_Config(PeftConfig):
    """
    ...
    def __post_init__(self):
        self.peft_type = PeftType.SVDDORA


class SVDDora_Model(torch.nn.Module):
    """
    ...
    def _find_and_replace(self):
        ...
        for key in key_list:
            ...
            if target_module_found:
                ...
                print(key, "finished(Model type: SVDDora_Model)")
...
class Linear(nn.Linear, LoraLayer):
    ...
    def forward(self, x: torch.Tensor):
        ...
        if self.disable_adapters:
            ...
            # self.weight_m_wdecomp.weight: [out_features, 1] ---view(-1)---> [1, out_features]
