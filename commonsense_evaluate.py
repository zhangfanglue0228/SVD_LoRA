...
def parse_args():
    ...
    parser.add_argument('--adapter', choices=['LoRA', 'AdapterP', 'AdapterH', 'Parallel', 'DoRA', 'SVDLoRA', 'SVDinitLoRA_v1', 'SVDinitLoRA_v2', 'SVDinitLoRA_v3'],
                        required=True)
